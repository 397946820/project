...
public class LightTotalModel {
	...
	@ExcelLink(title="excel中SKU(B)的总金额",index = 5)
	private Double excelBSkuTotalPrice;
	@ExcelLink(title="excel中SKU(OS)的总金额",index = 6)
	private Double excelOSSkuTotalPrice;

	

	public Double getExcelBSkuTotalPrice() {
		return excelBSkuTotalPrice;
	}

	public void setExcelBSkuTotalPrice(Double excelBSkuTotalPrice) {
		this.excelBSkuTotalPrice = excelBSkuTotalPrice;
	}

	public Double getExcelOSSkuTotalPrice() {
		return excelOSSkuTotalPrice;
	}

	public void setExcelOSSkuTotalPrice(Double excelOSSkuTotalPrice) {
		this.excelOSSkuTotalPrice = excelOSSkuTotalPrice;
	}
