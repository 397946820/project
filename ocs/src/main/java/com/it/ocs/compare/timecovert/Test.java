package com.it.ocs.compare.timecovert;
...
public class Test {
	...
	public static void main(String[] args) throws java.text.ParseException {
		...
		// 原时区的时间
		String sourceTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date());
		// 原时区东八区Asia/Shanghai,GMT+8:00
		String sourceId = "Asia/Shanghai";
//		String sourceId = "America/Los_Angeles"; //US
//		String sourceId = "Asia/Tokyo";   		 //JP
//		String sourceId = "Europe/Berlin";		 //DE
//		String sourceId = "Europe/Paris";		 //FR
//		String sourceId = "Europe/London";		 //UK
//		String sourceId = "Europe/Madrid";	  	 //ES
//		String sourceId = "Europe/Rome";	  	 //IT
		// 目标时区America/Los_Angeles
		String targetId = "UTC";
		// 转换后的时间
	 ...
	 */
	public static String timeConvert(String sourceTime, String sourceId, String targetId) throws java.text.ParseException {
		// 校验入参是否合法
