...
public class ParseLightOrderXMLNodeOne extends ParseXMLModel {

	public ParseLightOrderXMLNodeOne(Document document, String nameSpace) {
	...
	public List<Map<String, Object>> getResult() {
		...
		List<Element> itemNodes = this.getElementChild(root, "item");// this.getElementChild("callReturn_item");
		result.add(formatData(itemNodes));
		return result;
	}
