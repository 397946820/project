...
//  private DataFormatter formatter = new DataFormatter();  
     ...
     * @throws SAXException 
     */  
    public BigExcelReader(String filename,InputStream is) throws IOException, OpenXML4JException, SAXException{  
        setSheet(is);
    ...
    private void init(OPCPackage pkg) throws IOException, OpenXML4JException, SAXException{  
       ...
       // sheet = xssfReader.getSheet("2017NovMonthlyTransaction (7)");  
...
//                      }  
	...
	public InputStream getSheet() {
		return sheet;
	}

	public void setSheet(InputStream sheet) {
		this.sheet = sheet;
	}  
