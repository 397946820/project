package com.it.ocs.email.service;
...
public class SendMailService {
	 public static void main1(String[] args) throws Exception {
	    ...
	    public static String myEmailAccount = "chenyong@ledbrighter.com";
	    ...
	    // 收件人邮箱（替换为自己知道的有效邮箱）
	    public static String receiveMailAccount = "chenyong@ledbrighter.com";
