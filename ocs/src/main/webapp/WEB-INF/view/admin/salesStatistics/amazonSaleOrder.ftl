...
<@FTL.admin id="amazonSaleOrder" title="亚马逊销售订单"
add_script_files=['admin/salesStatistics/amazonSaleOrder.js','admin/salesStatistics/saleOrderRefund.js']>

<@saleOrder.saleOrderRefund></@>

<table id="amazonSaleOrderdatagrid" style="width: 100%; height: auto"></table>

<div id="amazonSaleOrderToolbar">
	<div>
		<form id="amazonSaleOrderSearchForm">
			<table style="min-width: 600px;">
				<tr style="min-width: 600px;">
					...
					<td>
						<select name="platform" id="platform" class="easyui-combobox" style="width: 150px;" panelHeight="auto" editable="false">
							<option value="" ></option>
				...
				<tr style="min-width: 1000px;">
					...
					<td>
						<select name="channel" id="channel" class="easyui-combobox" style="width: 150px;" panelHeight="auto" editable="false">
							
						</select>
					</td>
					<td><label>订单状态:</label></td>
					<td>
						<select name="status" class="easyui-combobox" style="width: 150px;" panelHeight="auto" editable="false">
							<option value="" ></option>
					...
					<td>
						<input id="customerName" name="customerName" value="" />
					</td>
					<td align="right">
						<a id="amazonSaleOrderQuery" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>
						<a id="amazonSaleOrderReset" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-remove'">重置</a>
					</td>
				</tr>
			</table>
		</form>
	...
	<div>
		<a id="btn_exportUKNoShipOrders" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-download" plain="true">未发货补发单导出(UK)</a>
...
<div id="dialog_tn_upload_record" class="easyui-dialog" title="上传记录" style="width:930px;height:500px;"data-options="iconCls:'icon-save',
		...
		<form id="form_upload_record_filter">
			<table>
				<tr>
					...
					<td>
						<input class="easyui-textbox placeholder" name="orderId" style="width: 200px;" />
					</td>
	...
	<table id="dg_upload_record" class="easyui-datagrid" style="width: 100%; height: 90%;"></table>
</div>
...
<div id="amazonSaleOrderDetial" class="easyui-dialog" title="订单详情" closed="true" style="width:800px;height:auto;padding-bottom:50px;" 
		data-options="modal:true,buttons: [{
					text:'关闭',
					handler:function(){
						$('#amazonSaleOrderDetial').window('close');
					}
				}]">
		...
		<table id="amazonSaleOrderDetailDatagrid" class="easyui-datagrid" style="width:100%;height:auto;">
