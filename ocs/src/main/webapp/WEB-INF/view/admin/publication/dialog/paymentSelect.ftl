<#macro paymentSelect>
            <div class="saveAsListModel" style="display: none;height:100%" >
                 <div class=" dialogbox">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="dialoghead" style="cursor:move" id="_Draghandle_0">
                                                        <div id="_Title_0" class="dialog_title">选择付款方式</div>
                                            ...
                                            <tr>           
                                                <td valign="top" align="center" class="dialogmsghead" style="height:450px">
                                                    <div id="_MessageRow_0" class="dialogmsghead1" style="height:100%">
                                                        <table id="saveAsListGrid" class="easyui-datagrid" data-options="" style="height:450px;overflow:auto;"> </table>
                                                	</div>
                                            	</td>          
                                        	</tr>          
