<@FTL.admin id="fpxoperlog" title="4PX操作日志"
add_script_files=['admin/fourpx/fpxoperlog.js']>
<style type="text/css">
	...
	<form id="operlog_filter">
		<table>
			<tr>
				...
				<td>
					<input class="easyui-textbox" name="orderId" style="width: 300px;"><span class="tips">（*可输入OrderId）</span>
				</td>
			</tr>
			<tr>
