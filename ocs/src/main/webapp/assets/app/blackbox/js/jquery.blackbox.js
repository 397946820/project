...
(function () {
     ...
     * @param _delay_appear
     */
    BlackBox.fn.xbsAlert = function (text, callback, options, _delay_appear) {
        if (arguments.length === 0) return;
        var args = _getArgs.apply(this, arguments);
        if (!_setOverlay.call(this, 'xbsAlert', args, args[3]) && !args[3]) return;
        var $BlackBox = $("#BlackBox");
        $BlackBox.append('<div class = "system Inner" id="xbsAlert' + _getNowID.call(this) + '"><p>' + args[0] + '</p></div>');
        _boxWrap.call(this, $("#xbsAlert" + _getNowID.call(this)), args[2]);
